# WeatherGPT — 3-min Demo Narrative (plan.md 8.1)
...
|------|-----------------|--------------------------------|------------|
| 0:00 | "WeatherGPT, Pune ka mausam?" (Hindi) | Greeting in Hindi, then short forecast | `VoiceOrb.tsx:16` listening → thinking → speaking; live transcript |
...
| 2:30 | Close (presenter, not voice): "IMD portal: 7 clicks, needs English. WeatherGPT: 7 sec voice, no literacy." | — | Point to transcript + IMD Source + metrics overlay on screen |
